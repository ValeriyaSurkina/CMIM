...
plot(Q(:, 4), Q(:, 5), ...
    ...
    0, 0, '*', 'LineWidth', 2);
axis equal
title('Position Analysis for Slider Crank Mechanism')
legend({'Crank','Connection rod','Slider','Origin'},'Location','northeast')
...
plot(QP(:, 4), QP(:, 5), ...
    ...
    0, 0, '*', 'LineWidth', 2);
axis equal
title('Velocity Analysis for Slider Crank Mechanism')
legend({'Crank','Connection rod','Slider','Origin'},'Location','northeast')
...
plot(QPP(:, 4), QPP(:, 5), ...
    ...
    0, 0, '*', 'LineWidth', 2);
axis equal
title('Acceleration Analysis for Slider Crank Mechanism')
legend({'Crank','Connection rod','Slider','Origin'},'Location','northeast')